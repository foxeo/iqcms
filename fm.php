...
// IQ CMS File Mgr - http://iqcms.com/1f

// CONFIGURATION INFO
$config_username = "username";
$config_password = "password";
$config_hint = "just like it says only all lower case";
$config_title = "IQ CMS File Mgr";
$config_footer = date("Y")." by <a href='http://iqcms.com/1f'>IQ CMS</a>.";
$config_disabled = "bmp,ico,gif,jpg,png,psd,zip";
$config_excluded = "onefilecms.php,favicon";
...
<link href="<?php 
	if (file_exists("style.css")) {
		...
		echo "http://iqcms.com/1f/style.css";
	}
...
if ($page == "other") { ?>
	<h2>Other</h2>
	<h3>Useful Stuff</h3>
	<p>IQ CMS File Mgr is a Branded Clone of the WayCute and TiNi original rocktronica version of OneFileCMS.<br />For the latest version (self-evident onefilecms) <a href="http://onefilecms.com/download.php?v=<?php echo $version; ?>">click this link</a>. You are using version <?php echo $version; ?>.</p>
	<h3>Footer</h3>
	<p>Let people know you use IQ CMS by putting this in your footer:</p>
	<pre><code>Powered by &#60;a href="http://iqcms.com/"&#62;IQ CMS&#60;/a&#62;.</code></pre>
	<h3>Admin Link</h3>
	<p>Add this to your footer (or somewhere) for admins. They'll still have to know the username and password, of course ;-)</p>
